...
data_loc <- "C:/Users/srcorsi/OneDrive - DOI/GLRI Chicago Cresent/Data/63rd/Raw/"
data_loc_git <- file.path("20_process_data","out")
ibg <-read.csv(file = paste0(data_loc,"BeachGuardDataExport Illinois.csv"), stringsAsFactors = FALSE)
