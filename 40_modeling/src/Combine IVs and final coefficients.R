...
DataTestPeriod <- list(as.POSIXlt(c("2012-05-01","2014-10-01","2016-05-01","2017-10-01"))$year + 1900,
                       ...
                       as.POSIXlt(c("1997-01-01","2000-09-30","2004-12-31","2010-01-01"))$year + 1900,
                       as.POSIXlt(c("2010-01-01","2013-12-31","2014-01-01","2017-01-01"))$year + 1900,
                       as.POSIXlt(c("2005-01-01","2007-12-31","2016-12-31","2019-12-31"))$year + 1900,
                       as.POSIXlt(c("1997-01-01","2000-12-31","2015-12-31","2019-12-31"))$year + 1900)
